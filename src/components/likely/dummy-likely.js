...
const DummyLikely = props => {
    return (
        <div className="likely">
            <div className="likely__widget">
                <span className="likely__icon">
                    <svg
                ...
                <span className="likely__button">
                    {props.fullSize && "Facebook"}
                </span>
            </div>
            <div className="likely__widget">
                <span className="likely__icon">
